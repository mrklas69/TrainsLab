...
| **F7** | interakce vozů — odstavený volný vagon + srážky (mez energie → vykolejení) ✅; **výhybky / topologie sítě** — graf segmentů (fáze 1 ✅), **odbočka = θ-graf 2 uzly / 3 hrany, boční offset se spojitou omezenou κ** (fáze 2 ✅, DD-26), route-aware průjezd soupravy + výměnové terče (fáze 3 první řez ✅); domek s napaječkou + postupné doplnění zásob ✅; kontakty přes větve (fáze 4 🔧) | 🔧 |
